...
<section class="container mx-auto p-4 mt-4">
    ...
    <section class="container mx-auto p-4">
      ...
      <a href="mailto:<?= $listing->email ?>" class="block w-full text-center px-5 py-2.5 shadow-sm rounded border text-base font-medium cursor-pointer text-indigo-700 bg-indigo-100 hover:bg-indigo-200" >  Apply Now </a>
</section>
